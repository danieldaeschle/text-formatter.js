...
textSelected=""!==t},document.onclick=document.onscroll=function(e){-1===document.getElementById("highlightTooltip").outerHTML.indexOf(e.target.outerHTML)&&isTextFormatterVisible&&""===getSelectedText()&&(fadeOut(document.getElementById("highlightTooltip"),200),clearTimeout(delayedVisibleSetter),isTextFormatterVisible=!1)},document.onmouseup=document.onkeyup=function(){if(textSelected){var e=getSelectionCoords(),t=document.getElementById("highlightTooltip")
e.y>60?t.style.top=e.y-55+"px":t.style.top=e.y+25+"px",e.x<55?t.style.left="5px":t.style.left=e.x-50+"px",fadeIn(document.getElementById("highlightTooltip"),200),delayedVisibleSetter=setTimeout(function(){isTextFormatterVisible=!0},200)}}
...
var c=l.parentNode
c.removeChild(l),c.normalize()}}return{x:n,y:i}},fadeIn=function(e,t,o){var n=e.style,i=25/(t||300)
