...
var hideTooltip=function(){fadeOut(document.getElementById("highlightTooltip"),200),delayedVisibleSetter&&clearTimeout(delayedVisibleSetter),isTextFormatterVisible=!1},changeSize=function(e){var t=document.queryCommandValue("FontSize")||3
...
var a=l.parentNode
a.removeChild(l),a.normalize()}}return{x:n,y:i}},fadeIn=function(e,t,o){var n=e.style,i=25/(t||300)
